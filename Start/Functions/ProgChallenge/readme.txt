...
5- To return a Boolean indicating whether the string is a palindrome, and an integer
 that will be the length of the string if it is a palindrome or zero, or not. 
