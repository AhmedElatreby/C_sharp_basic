...
namespace RefAndOutParams
{
    class Program
    {
        ...
        {
            arg1 += 10; // this will only work once inside the function
        ...
        {
            arg1 += 10; // using the ref function will allow the function to reflect the changes when called later 

            Console.WriteLine($" using (raf) {arg1}");
        }
