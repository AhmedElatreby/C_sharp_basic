...
namespace ProgChallenge
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            CheckingAcct checking = new CheckingAcct("Jon", "Smith", 2500.0m);

            // Create the Savings Account with interest and initial balance
            SavingsAcct saving = new SavingsAcct("Jane", "Smith", 0.025m, 1000.0m);

            // Check the balances
            // Expected output should be 2500 and 1000 at this point
            Console.WriteLine($"Checking balance is £{checking.Balance:N2}");
            Console.WriteLine($"Savings balance is £{saving.Balance:N2}");
